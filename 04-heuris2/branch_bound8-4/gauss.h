...
struct str_fila{ // Fila com dois cabeçalhos: um apontando pro início e outro pro fim de uma lista ligada subentendida. Genial !!!
    conteudo *inicio;
    conteudo *fim;
};
...
// Funções de manipulação de filas (fila dinâmica):
